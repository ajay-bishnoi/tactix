        ...
        >
          <div className="container max-w-[1200px] mx-auto sm:px-[30px] px-6">
            <div className={`flex flex-col `}>
              ...
              >
                <div data-aos="fade-right" className="max-w-[536px] w-full">
                    <div
                    ...
                    >
                      <h2 className="max-w-[400px] font-display lg:text-start text-center lg:mx-0 mx-auto font-medium md:text-5xl lg:text-tiny-6xl sm:text-4xl text-3xl !leading-125 tracing-[0.04em] text-white uppercase">
                        {obj.title} <span className="px-[34px] clip-angled bg-red">{obj.redTitle}</span>{" "}
                ...
                <div data-aos="fade-left" className="max-w-[360px] sm:max-w-[470px] sm:h-[432px] lg:max-w-[485px] lg:h-[430px] xl:h-[505px] xl:max-w-[550px] w-full max-xl:justify-center flex justify-start">
                  <div className="xl:w-[550px] xl:h-[505] ">
                    <Image
                      ...
                      width={550}
                      height={506}
                      className="!w-full !h-full rounded-[20px] border border-off-grey pointer-none:"
                    />
                  </div>
                </div>
              </div>
